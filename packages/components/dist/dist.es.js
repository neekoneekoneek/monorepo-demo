import { resolveComponent, resolveDirective, withDirectives, openBlock, createBlock, mergeProps, withCtx, createElementBlock, Fragment, renderList } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _directive_select_load_more = resolveDirective("select-load-more");
  return withDirectives((openBlock(), createBlock(_component_el_select, mergeProps({
    ...
    default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList($options.compOptions, item => {
...
export { script$1 as MSelect, script as MTable };
